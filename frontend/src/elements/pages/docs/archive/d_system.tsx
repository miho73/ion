...
import {Badge, ListGroup, ListGroupItem, Stack, Table} from "react-bootstrap";
  ...
  return (
    <>
      ...
      <Stack gap={3}>
        ...
        <Stack className='mb-3 align-items-start'>
          ...
          <Badge as='span' className='w-fit p-2 d-inline' bg='primary'>FACULTY</Badge>
