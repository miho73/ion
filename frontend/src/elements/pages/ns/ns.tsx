...
function Ns() {
  ...
  return (
    <Stack className={'mx-auto'} gap={3}>
      ...
      <div>
        <h4>면불 신청</h4>
        <Form className={'d-flex flex-column gap-3 align-items-start mb-5'}>
          <Stack direction='horizontal' className={'flex-wrap column-gap-4 row-gap-2'}>
            <Form.Group className={'ns-form'}>
            ...
            <Form.Group className={'ns-form'}>
              ...
              <Form.Control type='text'
                            ...
                            value={revPlace} onChange={e => setRevPlace(e.target.value)}
              />
            </Form.Group>
            ...
            <Form.Group className={'ns-form'}>
              ...
              <Form.Control type='text'
                            value={revSup} onChange={e => setRevSup(e.target.value)}
                            disabled={working}
            ...
            <Form.Group className={'ns-form'}>
              ...
              <Form.Control type='text'
                            value={revRes} onChange={e => setRevRes(e.target.value)}
                            disabled={working}
          ...
          <div>
            <Form.Check label='자동완성'
                        id='autofill'
                        type='switch'
                        disabled={id === ''}
                        checked={autoFill} onChange={(e) => changeAf(e.target.checked)}
            />
          </div>
          <div>
            <Form.Check
          ...
          {lnsRoomRequired &&
            <div className='p-3 w-100 border lns'>
              <h5>노트북실 자리 예약</h5>
              {revTime === -1 &&
